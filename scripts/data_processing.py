...
def main():
    ...
    logging.basicConfig(filename='./scripts/my_loggging_info.log', encoding='utf-8', format='%(asctime)s %(message)s', datefmt='%Y/%m/%d %I:%M:%S %p', level=logging.INFO, force=True)
